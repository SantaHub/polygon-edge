...
import (
	...
	"github.com/SantaHub/polygon-edge/command/peers/add"
	"github.com/SantaHub/polygon-edge/command/peers/list"
	"github.com/SantaHub/polygon-edge/command/peers/status"
